...
import { ArrowRight, Store, Truck, CheckCircle2 } from 'lucide-react';
    ...
    <section id="two-sided-network" className="w-full py-16 md:py-24 relative bg-[#FAFCFB] border-t border-b border-slate-100 overflow-hidden scroll-mt-24">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h2 className="text-4xl sm:text-5xl font-extrabold text-[#161D1A] tracking-tight leading-[1.12] mb-4">
            {lang === 'en'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full items-stretch">
          ...
          <div className="w-full rounded-3xl p-6 sm:p-8 lg:p-10 bg-white border border-slate-200/90 shadow-lg hover:shadow-xl hover:border-[#48C293]/60 transition-all duration-300 flex flex-col justify-between group overflow-hidden">
            <div>
              {/* Card Header with Prominent Store Icon */}
              <div className="flex items-center justify-between mb-5">
                ...
                <div className="w-11 h-11 rounded-2xl bg-[#E9F8F2] text-[#17332A] flex items-center justify-center shrink-0 shadow-2xs">
                  <Store className="w-5.5 h-5.5 stroke-[2.2]" />
                </div>
              </div>
              ...
              {/* Description */}
              <p className="text-sm sm:text-base text-[#52605B] leading-relaxed mb-5">
                {lang === 'en'
              ...
              <ul className="space-y-2.5 mb-6">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-2.5 text-xs sm:text-sm text-[#161D1A]">
                    ...
                    <span className="leading-snug">{lang === 'en' ? item.en : item.nl}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="mt-auto pt-5 border-t border-slate-100 flex items-center justify-between">
              <a
                ...
                className="zineps-cta-btn px-6 py-2.5 rounded-xl font-bold text-xs sm:text-sm inline-flex items-center gap-2"
              >
          ...
          <div className="w-full rounded-3xl p-6 sm:p-8 lg:p-10 bg-white border border-slate-200/90 shadow-lg hover:shadow-xl hover:border-[#48C293]/60 transition-all duration-300 flex flex-col justify-between group overflow-hidden">
            <div>
              {/* Card Header with Prominent Truck Icon */}
              <div className="flex items-center justify-between mb-5">
                ...
                <div className="w-11 h-11 rounded-2xl bg-[#F3FBF7] text-[#17332A] flex items-center justify-center shrink-0 shadow-2xs">
            ...
            <div className="mt-auto pt-5 border-t border-slate-100 flex items-center justify-between">
              <a
                href="#partners"
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl font-bold text-xs sm:text-sm border border-slate-200 bg-white hover:bg-[#F3FBF7] hover:border-[#70CAB9] text-[#10241E] transition-all shadow-xs"
              >
